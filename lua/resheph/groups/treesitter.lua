...
function M.apply()
  ...
  vim.api.nvim_set_hl(0, "@number", { fg = p.brown })
  vim.api.nvim_set_hl(0, "@boolean", { fg = p.brown })
  ...
  vim.api.nvim_set_hl(0, "@keyword.operator", { fg = p.gold })
  ...
  vim.api.nvim_set_hl(0, "@operator", { fg = p.gold })
