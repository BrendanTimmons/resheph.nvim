...
function M.apply()
  ...
  vim.api.nvim_set_hl(0, "SnacksDashboardHeader", { fg = p.color4, bold = true })
  vim.api.nvim_set_hl(0, "SnacksDashboardFooter", { fg = p.fg3, italic = true })
  vim.api.nvim_set_hl(0, "SnacksDashboardKey", { fg = p.color4, bold = true })
  ...
  vim.api.nvim_set_hl(0, "SnacksPickerDim", { link = "Comment" })
  ...
  vim.api.nvim_set_hl(0, "SnacksPickerMatch", { fg = p.color4, bold = true })
  vim.api.nvim_set_hl(0, "SnacksPickerCursor", { fg = p.bg, bg = p.color6 })
  vim.api.nvim_set_hl(0, "SnacksPickerCursorLine", { fg = p.color4, bg = p.bg2, bold = true })
